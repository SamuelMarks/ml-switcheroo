...
class ApiTransformer(ApiHelpersMixin, ApiTransformerAttrMixin, ApiTransformerCallMixin, cst.CSTTransformer):
  ...
  def leave_Module(self, original_node: cst.Module, updated_node: cst.Module) -> cst.Module:
    ...
    new_stmts: List[Union[cst.SimpleStatementLine, cst.BaseCompoundStatement]] = []
    seen = set()
  ...
  def leave_SimpleStatementLine(
    ...
    if self.context.current_stmt_errors:
      ...
      return cast(
        Union[cst.BaseStatement, cst.FlattenSentinel[cst.BaseStatement], cst.RemovalSentinel],
        EscapeHatch.mark_failure(original_node, message),
      )
    ...
    if self.context.current_stmt_warnings:
      ...
      return cast(
        Union[cst.BaseStatement, cst.FlattenSentinel[cst.BaseStatement], cst.RemovalSentinel],
        EscapeHatch.mark_failure(updated_node, message),
      )
