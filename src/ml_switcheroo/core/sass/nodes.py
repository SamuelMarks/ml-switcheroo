...
class Register(Operand):
  ...
  Attributes:
      name: The register identifier (e.g., "R0", "RZ").
...
class Predicate(Operand):
  ...
  Attributes:
      name: The predicate identifier (e.g., "P0", "PT").
      negated: If True, indicates logical NOT (e.g., "!P0").
  """
...
class Immediate(Operand):
  ...
  Attributes:
      ...
      is_hex: If True, renders as hex string (e.g., "0x1").
  """
...
class Memory(Operand):
  ...
  Attributes:
      base: The base register (e.g., "R1") or constant bank string (e.g., "c[0x0]").
      offset: Optional byte offset to add to the base.
  """
...
class Instruction(SassNode):
  ...
  Attributes:
      opcode: The instruction mnemonic (e.g., "FADD", "MOV").
      operands: List of operand nodes.
      predicate: Optional predicate guard executed before instruction.
  """
...
class Directive(SassNode):
  ...
  Attributes:
      name: The directive name (e.g., "headerflags").
