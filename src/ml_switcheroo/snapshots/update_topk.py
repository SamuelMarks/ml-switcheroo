"""
Script to register 'TopK' operations.
"""
...
def update_topk_semantics():
  ...
  spec["TopK"] = {
    ...
    "std_args": ["input", "k", "dim", "largest", "sorted", "out"],
  }
  ...
  if jax_path.exists():
    ...
    mapping = {"api": "jax.lax.top_k", "requires_plugin": "topk_adapter"}

    snap["mappings"]["TopK"] = mapping
    snap["mappings"]["topk"] = mapping
  ...
  if torch_path.exists():
    ...
    t_snap["mappings"]["TopK"] = {"api": "torch.topk"}
    t_snap["mappings"]["topk"] = {"api": "torch.topk"}
