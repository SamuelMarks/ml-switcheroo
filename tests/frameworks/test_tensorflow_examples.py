...
def test_tensorflow_examples_structure(adapter: TensorFlowAdapter) -> None:
...
def test_tier1_math_validity(adapter: TensorFlowAdapter) -> None:
...
def test_tier2_neural_validity(adapter: TensorFlowAdapter) -> None:
