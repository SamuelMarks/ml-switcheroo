...
CASES = [
  ...
  ("tensorflow", "tf.math.add", "https://www.tensorflow.org/api_docs/python/tf/math/add"),
  ("keras", "keras.layers.Dense", "https://keras.io/search.html?q=keras.layers.Dense"),
  ("flax_nnx", "flax.nnx.Linear", "https://flax.readthedocs.io/en/latest/search.html?q=flax.nnx.Linear"),
  ("mlx", "mlx.core.abs", "https://ml-explore.github.io/mlx/build/html/python/_autosummary/mlx.core.abs.html"),
  ("paxml", "praxis.layers.Linear", "github.com/search?q=repo%3Agoogle%2Fpaxml"),
]
