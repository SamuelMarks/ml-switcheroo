...
def test_paxml_examples_structure(adapter: PaxmlAdapter) -> None:
...
def test_tier1_math_validity(adapter: PaxmlAdapter) -> None:
...
def test_tier2_neural_validity(adapter: PaxmlAdapter) -> None:
