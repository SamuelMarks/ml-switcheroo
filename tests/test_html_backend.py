...
def test_html_backend_empty_graph():
  """Docstring."""
  graph = LogicalGraph(
    nodes=[],
    edges=[],
...
def test_html_backend_input_output_only():
  """Docstring."""
  graph = LogicalGraph(
    nodes=[
