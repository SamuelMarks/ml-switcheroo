...
def test_transform_cuda_check(mock_get_adapter):
  """Docstring."""
  node = cst.Call(func=cst.Name("is_available"))
  ...
  result = transform_cuda_check(node, ctx)
  assert isinstance(result, cst.Comparison)


@patch("ml_switcheroo.plugins.device_checks.get_adapter")
def test_transform_cuda_check_no_adapter(mock_get_adapter):
  """Docstring."""
  node = cst.Call(func=cst.Name("is_available"))
  ctx = MagicMock(spec=HookContext)
...
@patch("ml_switcheroo.plugins.device_checks.get_adapter")
def test_transform_cuda_check_not_implemented(mock_get_adapter):
  """Docstring."""
  node = cst.Call(func=cst.Name("is_available"))
  ctx = MagicMock(spec=HookContext)
  ctx.target_fw = "jax"
...
@patch("ml_switcheroo.plugins.device_checks.get_adapter")
def test_transform_cuda_check_exception(mock_get_adapter):
  """Docstring."""
  node = cst.Call(func=cst.Name("is_available"))
  ctx = MagicMock(spec=HookContext)
  ctx.target_fw = "jax"
...
@patch("ml_switcheroo.plugins.device_checks.get_adapter")
def test_transform_cuda_check_no_syntax(mock_get_adapter):
  """Docstring."""
  node = cst.Call(func=cst.Name("is_available"))
  ctx = MagicMock(spec=HookContext)
  ctx.target_fw = "jax"
...
@patch("ml_switcheroo.plugins.device_checks.get_adapter")
def test_transform_cuda_check_bad_syntax(mock_get_adapter):
  """Docstring."""
  node = cst.Call(func=cst.Name("is_available"))
  ctx = MagicMock(spec=HookContext)
  ctx.target_fw = "jax"
