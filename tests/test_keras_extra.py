...
def test_keras_adapter_ghost_init_empty():
  """Test element."""
...
def test_keras_adapter_properties():
  """Test element."""
  adapter = KerasAdapter()
...
def test_keras_examples():
  """Test element."""
  ex = get_keras_tiered_examples()
  assert isinstance(ex, dict)


def test_keras_missing():
  """Test element."""
  adapter = KerasAdapter()
...
def test_keras_collect_ghost_data():
  """Test element."""
  adapter = KerasAdapter()
